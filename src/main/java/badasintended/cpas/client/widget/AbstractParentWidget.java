...
public abstract class AbstractParentWidget extends AbstractButtonWidget implements ParentElement {
    ...
    public void renderToolTip(MatrixStack matrices, int mouseX, int mouseY) {
        matrices.push();
        matrices.translate(0, 0, itemRenderer().zOffset + 250);
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        for (AbstractButtonWidget child : children) {
    ...
    @Override
    final public List<AbstractButtonWidget> children() {
        return children;
    }
